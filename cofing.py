...
OWNER_USERNAME = getenv("OWNER_USERNAME", "KingAra")
BOT_USERNAME = getenv("BOT_USERNAME", "SoicBot")
BOT_NAME = getenv("BOT_NAME", "Sli Music")
...
# ======================================================
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/tgwalehm-byte/Chhoti-music")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN", "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")

# ======================================================
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/messo_network")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Chhoti_bot_support")
...
# ======================================================
START_IMG_URL = getenv("START_IMG_URL", "https://anya-file-host.vercel.app/yf12dfgec1")
PING_IMG_URL = getenv("PING_IMG_URL", "https://anya-file-host.vercel.app/xm492wlsvs")
...
SHASHANK_PIC = [
    "https://anya-file-host.vercel.app/ups5eq51s6"
]
# ======================================================
